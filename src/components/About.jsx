    ...
    <section className="z-20 bg-primary pt-14">
      ...
      >
        ...
        <span className="hidden sm:inline">
          From there, I will create wireframes and prototypes to ensure that the
          design and functionality are both user-friendly and visually
          ...
          engines. Throughout the development process, I will keep you informed
          of my progress and will be open to feedback and revisions to ensure
          that the final product meets your expectations. In addition to my
          ...
          you for considering me for your web development project. I look
          forward to discussing the details further and answering any questions
          you may have.
        </span>
      </motion.p>
